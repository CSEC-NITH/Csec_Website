  ...
  return (
    <>
      <div className="relative">
        ...
        <h1
          className={
            "text-4xl md:text-6xl absolute inset-0 bottom-10 flex items-center justify-center font-bold "
          }
        >
          GALLERY
        </h1>
      ...
      <div className="p-5 sm:p-8">
        <div className="columns-1 sm:columns-2 md:columns-3 lg:columns-4 gap-4 [&>div:not(:first-child)]:mt-8">
          {[...Array(16)].map((_, index) => (
            ...
            >
              <Image
                className="cursor-pointer hover:scale-150 translate-transform duration-500 ease-in-out"
                style={{
                  transformOrigin: `${mousePointer.x}% ${mousePointer.y}%`,
                }}
                src={`/featured/anime${index + 3}.jpeg`}
                alt="anime"
                width={500}
                height={600}
              />
