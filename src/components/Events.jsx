  ...
  return (
    <div className="flex justify-center flex-col items-center">
      <div className=" flex gap-2 items-center mx-8 mt-12 mb-4 md:mb-6">
        <div className="bg-gradient-to-br from-gray-300 to-slate-700 w-2 h-7"></div>
        <h1 className={"text-3xl md:text-4xl font-bold "}>PAST EVENTS</h1>
      </div>
        ...
        {events.map((event) => (
          <Card key={event.event} className="md:w-[350px] w-[250px]">
            <CardHeader className="flex justify-center items-center">
              ...
              <CardDescription className={inria.className}>
                {event.desc}.
              </CardDescription>
            </CardHeader>
            ...
            <CardFooter className="flex justify-between">
              <Button
                ...
                className="w-full font-semibold md:text-lg text-md"
                variant="outline"
              >
                Explore
              </Button>
